...
import com.demos.vedioplaybygsyplayer.view.SampleControlVideo;
...
//    private String url = "rtsp://61.138.102.214:619/1101:admin:paxy2019@10.1.29.53:554:0:0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PlayerActivityPermissionsDispatcher.shotImageWithPermissionCheck(PlayerActivity.this, v);
            }
        });
        ...
        startGif.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PlayerActivityPermissionsDispatcher.startGifWithPermissionCheck(PlayerActivity.this);
            }
        });
        ...
        if (getGSYVideoPlayer().getFullscreenButton() != null) {
            getGSYVideoPlayer().getFullscreenButton().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    getGSYVideoPlayer().startWindowFullscreen(PlayerActivity.this, true, true);
                }
            });
        }
    }
    ...
    private void showToast(final String tip) {
        detailPlayer.post(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(PlayerActivity.this, tip, Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        PlayerActivityPermissionsDispatcher.onRequestPermissionsResult(this, requestCode, grantResults);
    }
